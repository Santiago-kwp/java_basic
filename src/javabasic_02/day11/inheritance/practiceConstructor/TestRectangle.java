...
public class TestRectangle {
	public static void main(String s[]){
		...
		System.out.println("넓이는 " + (( rec1.area() == rec2.area() ) ? "같습니다.": (rec1.area() > rec2.area()) ? rec1.getColor()+" 직사각형이 더 큽니다.":rec2.getColor()+"직사각형이 더 큽니다."));
		// TODO 2) 두 직사각형의 둘레를 비교하십시오.
		System.out.println("넓이는 " + (( rec1.perimeter() == rec2.perimeter() ) ? "같습니다.": (rec1.area() > rec2.area()) ? rec1.getColor()+"직사각형이 더 큽니다.":rec2.getColor()+" 직사각형이 더 큽니다."));

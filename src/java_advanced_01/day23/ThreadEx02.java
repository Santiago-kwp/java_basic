...
class User1 extends Thread {
  ...
  public User1() {
    setName("User1 의 Thread"); // 스레드의 이름 변경
  }
...
class User2 extends Thread {
  ...
  public User2() {
    setName("User2 의 Thread"); // 스레드의 이름 변경
  }
...
// Caculator를 생성해서 User1 과 User2 에서 사용하도록 setCalculator() 메소드를 호출하고 두 스레드를 시작시키면 알아서 동작한다.

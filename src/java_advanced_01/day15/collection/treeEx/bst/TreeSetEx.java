...
public class TreeSetEx {
    public static void main(String[] args) {
        ...
        // 특정 점수 객체를 가져오기 : first(), last() 등의 메소드
        ...
        System.out.println("95점이거나 바로 높은 점수 " + score.ceiling(85));

        // 기본은 오름차순 정렬 지원
        // 내림차순 정렬하고 싶다.
        NavigableSet<Integer> descendingOrders = score.descendingSet();
        for (Integer i : descendingOrders) {
            System.out.print(i + " ");
        }
        System.out.println();

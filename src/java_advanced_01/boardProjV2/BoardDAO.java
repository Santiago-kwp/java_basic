...
import java_advanced_01.boardProjV2.common.BoardText;
import java_advanced_01.boardProjV2.common.ValidCheck;
import java_advanced_01.boardProjV2.exception.BoardException;

import java.text.SimpleDateFormat;
import java.util.*;

// MVC 패턴에서 Controller 역할
// 일반적인 DAO 클래스는 CRUD 메소드를 포함함
// Ex. insert(), select() or get(), update(), delete() 등
public class BoardDAO {
    ...
    // 데이터를 CRUD 로직으로 다루기 위해서는 보드 매니저가 필요하다 => 생성자 인젝션으로 구현

...
public class OptionalEx01 {
    public static void main(String[] args) {
        ...
        double avg = list.stream().mapToInt(Integer::intValue).average().getAsDouble(); //.NoSuchElementException: No value present
        ...
        // 방법4
        list.stream().mapToInt(Integer::intValue).average().ifPresentOrElse(System.out::println, ()->System.out.println("0"));
